    ...
    public function run(): void
    {
        ...
        $employees = [
            [
                ...
                'strdepartment' => 'Information Technology',
                'strdesignation' => 'Software Engineer',
                'ysnactive' => 1,
                'RelioGion' => 'Christianity',
                'bloodGroup' => 'O+',
                'Gender' => 'Male',
                'ysnAdmin' => 1,
                'shiftName' => 'M-3', // Mapped cleanly to M-3 Morning Shift
                'orderNumber' => 1,
                'ysnRoster' => 0,
                'cmpID' => 1,
                'entryBy' => 'sa',
                'entryDate' => now(),
                'reporting_boss' => 'System Admin',
            ...
            [
                ...
                'strdepartment' => 'Human Resources',
                'strdesignation' => 'HR Officer',
                'ysnactive' => 1,
                'RelioGion' => 'Islam',
                'bloodGroup' => 'A+',
                'Gender' => 'Female',
                'ysnAdmin' => 0,
                'shiftName' => 'M-4', // Mapped cleanly to M-4 Morning Shift
                'orderNumber' => 2,
                'ysnRoster' => 0,
                'cmpID' => 1,
                'entryBy' => 'sa',
                'entryDate' => now(),
                'reporting_boss' => 'Justin Mason',
            ...
            [
                'User_id' => '10003',
                'card_number' => 'CARD-9910',
                'strName' => 'Michael Chang',
                'strdepartment' => 'Production Department',
                'strdesignation' => 'Floor Supervisor',
                'ysnactive' => 1,
                'RelioGion' => 'Buddhism',
                'bloodGroup' => 'B+',
                'Gender' => 'Male',
                'ysnAdmin' => 0,
                'shiftName' => 'E-1', // Mapped cleanly to E-1 Evening Shift
                'orderNumber' => 3,
                'ysnRoster' => 1,
                'cmpID' => 1,
                'entryBy' => 'sa',
                'entryDate' => now(),
                'reporting_boss' => 'Justin Mason',
                'email' => 'michael.chang@corporate.com',
                'mobile_no' => '+15550194',
